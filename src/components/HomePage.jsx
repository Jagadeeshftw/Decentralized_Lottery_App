...
const HomePage = () => {
  const { handleDisplayPage } = useContext(LotteryContext);
  return (
    <div
        ...
        <div className="col-lg-6 mx-auto">
          ...
          <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <button
              ...
              onClick={() => handleDisplayPage("Wallet")}
            >
              Connect your wallet
            </button>
            <button
        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
          <div className="modal-content bg-dark text-secondary">
            <div className="modal-header">
              <h5
                className="modal-title display-7 fw-bold text-white"
            ...
            <div className="modal-body">
              ...
              <p>
                Welcome to our decentralized lottery system. By participating,
                you have a fair and equal chance to win the entire pool of
                collected funds. Here’s how it works:
              </p>

              <h5 className="text-white">How to Enter</h5>
              <p>
                To join the lottery, simply connect your wallet and send at
                least 0.01 ether. This amount will be added to the lottery pool,
                and your address will be entered into the draw.
              </p>
              ...
              <ul>
                ...
                <li>
                  The winner is chosen randomly using a combination of block
              ...
              <p>
                Ready to try your luck? Connect your wallet and join the lottery
                now. Good luck!
              </p>
            </div>
